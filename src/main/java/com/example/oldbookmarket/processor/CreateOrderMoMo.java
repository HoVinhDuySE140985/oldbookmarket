package com.example.oldbookmarket.processor;




import com.example.oldbookmarket.enumcode.RequestType;
import com.example.oldbookmarket.shared.constants.Parameter;
import com.example.oldbookmarket.shared.exception.MoMoException;

import com.mservice.shared.utils.Encoder;
import com.example.oldbookmarket.Configuration.Environment;
import com.example.oldbookmarket.enumcode.Language;
import com.example.oldbookmarket.models.HttpResponse;
import com.example.oldbookmarket.models.PaymentRequest;
...
public class CreateOrderMoMo extends AbstractProcess<PaymentRequest, PaymentResponse> {
    ...
    public PaymentRequest createPaymentCreationRequest(String orderId, String requestId, String amount, String orderInfo,
                                                           String returnUrl, String notifyUrl, String extraData, com.example.oldbookmarket.enumcode.RequestType requestType, Boolean autoCapture) {
