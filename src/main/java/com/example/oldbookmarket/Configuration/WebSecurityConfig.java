...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
   ...
   MyUserService myUserService;
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        configuration.setAllowedOrigins(Arrays.asList("http://localhost:3000/","http://localhost:3001/","http://localhost:8080/","https://thriving-crumble-cf370e.netlify.app/","https://moonlit-sopapillas-47c223.netlify.app/")); //or add * to allow all origins
